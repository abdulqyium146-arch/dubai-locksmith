// ─────────────────────────────────────────────────────────────────────────────
// Lock Repair Satwa — Bilingual Locations Hub Page
// [locale]/locations/page.tsx
// ─────────────────────────────────────────────────────────────────────────────
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: `${SITE_URL}/en/locations`,
        ar: `${SITE_URL}/ar/locations`,
      },
    },
    openGraph: {
      type: 'website',
...
// ── LocalBusiness schema with all areas in areaServed ────────────────────────
...
export default async function LocationsPage({
  ...
  // Split locations into two visual groups: nearest (≤25 min) and wider coverage
