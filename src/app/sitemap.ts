...
import { getAllCarBrandSlugs } from '@/data/car-brands'
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const carBrandSlugs = getAllCarBrandSlugs()
  ...
  return [
    ...
    // ── Individual car brand pages (priority 0.85) ────────────────────────────
    ...carBrandSlugs.map((slug) => ({
      url: `${SITE_URL}/car-brands/${slug}`,
      lastModified: now,
      changeFrequency: 'monthly' as const,
      priority: 0.85,
    })),
