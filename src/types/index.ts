// ─────────────────────────────────────────────────────────────────────────────
// Lock repair service — Shared TypeScript Types
// ─────────────────────────────────────────────────────────────────────────────
...
export interface CarBrandPriceRange {
  service: string
  min: number
  max: number
  turnaround: string
...
export interface CarBrand {
  ...
  popularModelsUAE: string[]
  /** Human-readable description of key system generations for this brand */
  keySystems: string[]
  /** Real brand-specific technical issues — NOT generic filler */
  commonIssues: string[]
  transponderChipTypes?: string[]
  priceRangeAED: CarBrandPriceRange[]
  turnaroundTime: string
  /** 1-2 paragraph brand-specific OEM vs aftermarket comparison */
  oemVsAftermarket: string
  /** 5-8 brand-specific FAQs — NOT generic */
  faqs: Faq[]
  relatedServiceSlugs: string[]
  relatedLocationSlugs: string[]
  metaTitle: string
  metaDescription: string
  /** 40-60 words, extractable by AI Overviews / featured snippets */
  directAnswerOpener: string
  /** 100-200 words brand-specific intro, split by \n\n for paragraphs */
  uniqueIntro: string
  icon: string
  /** If true, data needs human verification before publishing */
  needsReview?: boolean
}
